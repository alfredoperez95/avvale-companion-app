...
export function buildOfferExtractionPrompt(params: {
  ...
  const prompt = [
    ...
    '  \"areaCompania\": \"RUN\" | \"GROW\" | \"SAIBORG\" | \"WISE\" | \"YUBIQ\" | \"AXAZURE\" | null,',
    '  \"resumen\": string | null,',
    ...
    '',
    '5) areaCompania',
    '- Debe devolver SOLO una de estas: RUN, GROW, SAIBORG, WISE, YUBIQ, AXAZURE.',
    ...
    '',
    '- RUN:',
    '  infraestructura, comunicaciones, operación, monitorización, upgrades, instalaciones técnicas, Basis, administración cloud/on-prem, soporte técnico, AMS funcional, operación SAP o no SAP. Migraciones a Azure, hosting, landing zone, IaaS/PaaS u operación cloud genérica son RUN si no tienen como protagonista Dynamics 365, Business Central o F&O.',
    '',
    '- GROW:',
    '  implementación funcional, procesos, consultoría funcional, T&M funcional, desarrollo ABAP, assessments funcionales. Si el assessment o implantación es específicamente de Dynamics 365, CRM Microsoft, ERP Microsoft, Business Central o Power Platform de negocio, clasifícalo como AXAZURE.',
    '',
    '- SAIBORG:',
    '  integración (Mulesoft, SAP Integration Suite, Boomi), sustitución de middleware, Data (PowerBI, Tableau, Qlik, Datasphere, DWC, SAC), federación del dato, IA, OpenPlatform, Aurora, Fiori, BTP, CAP. Power BI aislado sin Dynamics 365 / Business Central / F&O como núcleo es SAIBORG, no AXAZURE.',
    '',
    '- WISE:',
    ...
    '',
    '- AXAZURE:',
    '  línea Microsoft Business Applications: marca Axazure, www.axazure.com, prefijo [AXAZURE] en el nombre del archivo, Dynamics 365 (Sales, Customer Service, Field Service, Marketing, Customer Insights), CRM Dynamics, ERP Microsoft (Finance & Operations / F&O, Supply Chain Management, Business Central) o Power Platform de negocio (Power Apps, Power Automate, Power Pages, Dataverse, Copilot Studio) como productos protagonistas. Incluye implantaciones, roll-outs, upgrades, AMS o assessments centrados en esas soluciones. No uses AXAZURE por Azure infraestructura genérica, hosting, Microsoft 365 genérico o BI aislado sin Dynamics protagonista.',
    '',
    '6) dealType',
