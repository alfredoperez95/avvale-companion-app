...
export function mergeTranslatedExtraction(
  ...
  return {
    ...
    importeTotalDealComputablesTexto: pickOptStr(
      parsed.importeTotalDealComputablesTexto,
      original.importeTotalDealComputablesTexto,
    ),
    notaImporteTotalDealComputables: pickOptStr(
      parsed.notaImporteTotalDealComputables,
      original.notaImporteTotalDealComputables,
    ),
