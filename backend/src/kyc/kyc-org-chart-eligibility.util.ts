/**
 * Paridad con frontend/src/features/kyc/kycOrgChartFilter.ts — mantener en sync al cambiar reglas.
 * Oculta del organigrama interno a partners tecnológicos y competencia.
 */
...
export type KycOrgMemberEligibilityInput = {
  name: string;
  role?: string | null;
  area?: string | null;
  notes?: string | null;
...
export function isExcludedFromInternalOrgChart(m: KycOrgMemberEligibilityInput): boolean {
